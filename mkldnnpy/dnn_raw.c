...
// This is the wrapper of 'raw' mkl-dnn interfaces, this is the level you should
// come to if other level of wrappers failed your needs
#include <mkldnn.h>
 ...
 */
mkldnn_status_t
primitive_desc_iterator_create(
...
{
    return mkldnn_primitive_desc_iterator_create(
        iterator, op_desc, engine, hint_forward_primitive_desc)
}

/** Iterates over primitive descriptors. Returns #mkldnn_iterator_ends if no
 * more primitive descriptors are available */
mkldnn_status_t
primitive_desc_iterator_next(
        mkldnn_primitive_desc_iterator_t    iterator)
{
    return mkldnn_primitive_desc_iterator_next(iterator);
}
...
mkldnn_status_t
primitive_desc_iterator_destroy(
        mkldnn_primitive_desc_iterator_t    iterator)
{
    return mkldnn_primitive_desc_iterator_destroy(iterator);
}
        ...
        const_mkldnn_primitive_desc_t   hint_forward_primitive_desc)
{
    return mkldnn_primitive_desc_create(
        primitive_desc, op_desc, engine, hint_forward_primitive_desc);
}

/** Makes a copy of a @p primitive_desc. */
mkldnn_status_t
primitive_desc_clone(
        mkldnn_primitive_desc_t         *primitive_desc,
        const_mkldnn_primitive_desc_t   existing_primitive_desc)
{
    return mkldnn_primitive_desc_clone(
        primitive_desc, existing_primitive_desc);
}
...
primitive_desc_destroy(
        mkldnn_primitive_desc_t         primitive_desc)
{
    return mkldnn_primitive_desc_destroy(primitive_desc);
}
 ...
 * @sa mkldnn_query_t */
mkldnn_status_t
primitive_desc_query(
        const_mkldnn_primitive_desc_t   primitive_desc,
        mkldnn_query_t                  what,
        int                             index,
        void                            *result)
{
    return mkldnn_primitive_desc_query(primitive_desc, what, index, result);
}
...
primitive_desc_query_memory_d(
        const_mkldnn_primitive_desc_t   primitive_desc)
{
    return mkldnn_primitive_desc_query_memory_d(primitive_desc);
}
...
primitive_desc_query_pd(
        const_mkldnn_primitive_desc_t   primitive_desc,
        mkldnn_query_t                  what,
        int                             index)
{
    return mkldnn_primitive_desc_query_pd(primitive_desc, what, index);
}
...
int
primitive_desc_query_s32(
        const_mkldnn_primitive_desc_t   primitive_desc,
        mkldnn_query_t                  what,
        int                             index)
{
    return mkldnn_primitive_desc_query_s32(primitive_desc, what, index);
}
...
{
    return mkldnn_primitive_create(primitive, primitive_desc, inputs, outputs);
}
...
mkldnn_status_t
primitive_get_primitive_desc(
        const_mkldnn_primitive_t        primitive,
        const_mkldnn_primitive_desc_t   *primitive_desc)
{
    return mkldnn_primitive_get_primitive_desc(primitive, primitive_desc);
}

/** For a @p primitive, returns @p input at the @p index position. */
mkldnn_status_t mkldnn_primitive_get_input_at(
        const_mkldnn_primitive_t primitive, size_t index,
        mkldnn_primitive_at_t *input);
{
    return mkldnn_primitive_get_input_at(primitive, index, input);
}

/** For a @p primitive, returns @p output at the @p index position. */
mkldnn_status_t mkldnn_primitive_get_output(
        const_mkldnn_primitive_t primitive, size_t index,
        const_mkldnn_primitive_t *output);
{
    return mkldnn_primitive_get_output(primitive, index, output);
}

/** Deletes a @p primitive. */
mkldnn_status_t mkldnn_primitive_destroy(
        mkldnn_primitive_t primitive);
{
    return mkldnn_primitive_destroy(primitive);
}
...
mkldnn_primitive_at_t mkldnn_primitive_at(
        const_mkldnn_primitive_t primitive, size_t output_index);
{
    return mkldnn_primitive_at(primitive, output_index);
}
...
mkldnn_status_t mkldnn_memory_desc_init(
...
{
    return mkldnn_memory_desc_init(memory_desc, ndims, dims, data_type, format);
}
...
{
    return mkldnn_memory_primitive_desc_create(
        memory_primitive_desc, memory_desc, engine);
}
...
mkldnn_status_t mkldnn_view_primitive_desc_create(
...
{
    return mkldnn_view_primitive_desc_create(
        view_primitive_desc, memory_primitive_desc, dims, offsets);
}
 ...
 * descriptors. */
int mkldnn_memory_primitive_desc_equal(
        const_mkldnn_primitive_desc_t lhs,
        const_mkldnn_primitive_desc_t rhs);
{
    return mkldnn_memory_primitive_desc_equal(lhs, rhs);
}

/** Returns the size (in bytes) that is required for given @p
 * memory_primitive_desc */
/* XXX: view? */
size_t mkldnn_memory_primitive_desc_get_size(
        const_mkldnn_primitive_desc_t memory_primitive_desc);
{
    return mkldnn_memory_primitive_desc_get_size(memory_primitive_desc);
}

/** For a @p memory primitive, returns the data @p handle. For the CPU engine,
 * the data handle is a pointer to the actual data. */
/* XXX: view? */
mkldnn_status_t mkldnn_memory_get_data_handle(
        const_mkldnn_primitive_t memory, void **handle);
{
    return mkldnn_memory_get_data_handle(memory, handle);
}

/** For a @p memory primitive, sets the data @p handle. */
mkldnn_status_t mkldnn_memory_set_data_handle(
        mkldnn_primitive_t memory, void *handle);
{
    return mkldnn_memory_set_data_handle(memory, *handle);
}
...
{
    return mkldnn_reorder_primitive_desc_create(
        reorder_primitive_desc, input, output);
}
 ...
 * automatically. */
mkldnn_status_t mkldnn_concat_primitive_desc_create(
...
{
    return mkldnn_concat_primitive_desc_create(
        concat_primitive_desc, output_desc, n, concat_dimension, input_pds);
}
...
mkldnn_status_t mkldnn_concat_inplace_by_input_primitive_desc_create(
        mkldnn_primitive_desc_t *concat_primitive_desc,
        int n, int concat_dimension, const_mkldnn_primitive_desc_t *inputs);
{
    return mkldnn_concat_inplace_by_input_primitive_desc_create(
        concat_primitive_desc, n, concat_dimension, inputs);
}
 ...
 * @note this primitive is more like a synchronization stub for concatenation,
 * since concat_inplace does no operation during execution. */
mkldnn_status_t mkldnn_concat_inplace_by_output_primitive_desc_create(
        mkldnn_primitive_desc_t *concat_primitive_desc,
        const mkldnn_primitive_desc_t output, int n, int concat_dimension,
        int *sizes);
{
    return mkldnn_concat_inplace_by_output_primitive_desc_create(
        concat_primitive_desc, output, n, concat_dimension, sizes);
}
#endif
 ...
 * format -- in this case appropriate memory format would be chosen
 * automatically. */
mkldnn_status_t mkldnn_sum_primitive_desc_create(
        mkldnn_primitive_desc_t *sum_primitive_desc,
        const mkldnn_memory_desc_t *output_desc, int n, double* scale,
        const_mkldnn_primitive_desc_t *input_pds);
{
    return mkldnn_sum_primitive_desc_create(
        sum_primitive_desc, output_desc, n, scale, input_pds);
}
...
mkldnn_status_t mkldnn_convolution_forward_desc_init(
...
{
    return mkldnn_convolution_forward_desc_init(
        conv_desc, prop_kind, alg_kind, src_desc, weights_desc, bias_desc,
        dst_desc, strides, padding_l, mkldnn_dims_t padding_r, padding_kind);
}
...
mkldnn_status_t mkldnn_convolution_backward_data_desc_init(
        ...
        mkldnn_padding_kind_t padding_kind);
{
    return mkldnn_convolution_backward_data_desc_init(
        conv_desc, alg_kind, diff_src_desc, weights_desc, diff_dst_desc,
        strides, padding_l, padding_r, padding_kind);
}
 ...
 * value of @p format_kind. */
mkldnn_status_t
convolution_backward_weights_desc_init(
        ...
        mkldnn_padding_kind_t       padding_kind)
{
    return mkldnn_convolution_backward_weights_desc_init(
        conv_desc, alg_kind, src_desc, diff_weights_desc, diff_bias_desc,
...
mkldnn_status_t mkldnn_relu_forward_desc_init(
        mkldnn_relu_desc_t *relu_desc, mkldnn_prop_kind_t prop_kind,
        const mkldnn_memory_desc_t *data_desc, double negative_slope);
{
    return mkldnn_relu_forward_desc_init(
        relu_desc, prop_kind, data_desc, negative_slope);
}
...
mkldnn_status_t mkldnn_relu_backward_desc_init(
        mkldnn_relu_desc_t *relu_desc,
        const mkldnn_memory_desc_t *diff_data_desc,
        const mkldnn_memory_desc_t *data_desc, double negative_slope);
{
    return mkldnn_status_t mkldnn_relu_backward_desc_init(
        relu_desc, diff_data_desc, data_desc, negative_slope);
}
...
mkldnn_status_t mkldnn_softmax_forward_desc_init(
        mkldnn_softmax_desc_t *softmax_desc, mkldnn_prop_kind_t prop_kind,
        const mkldnn_memory_desc_t *data_desc, int softmax_axis);
{
    return mkldnn_softmax_forward_desc_init(
        softmax_desc, prop_kind, data_desc, softmax_axis);
}
 ...
 *
 * @todo clarify! */
mkldnn_status_t mkldnn_pooling_forward_desc_init(
...
{
    return mkldnn_pooling_forward_desc_init(
        pool_desc, prop_kind, alg_kind, src_desc, dst_desc, strides,
        kernel, padding_l, padding_r, padding_kind);
}
 ...
 *
 * @todo clarify! */
mkldnn_status_t mkldnn_pooling_backward_desc_init(
        ...
        const mkldnn_dims_t padding_r, mkldnn_padding_kind_t padding_kind);
{
    return mkldnn_pooling_backward_desc_init(
        pool_desc, mkldnn_alg_kind_t alg_kind, diff_src_desc, diff_dst_desc,
        strides, kernel, padding_l, padding_r, padding_kind);
}
...
mkldnn_status_t mkldnn_lrn_forward_desc_init(
...
{
    return mkldnn_lrn_forward_desc_init(
        lrn_desc, prop_kind, alg_kind, data_desc, local_size, alpha, beta);
}
 ...
 * parameters @p local_size, @p alpha, and @p beta. */
mkldnn_status_t mkldnn_lrn_backward_desc_init(
        mkldnn_lrn_desc_t *lrn_desc, mkldnn_alg_kind_t alg_kind,
        const mkldnn_memory_desc_t *diff_data_desc,
        const mkldnn_memory_desc_t *data_desc, int local_size, double alpha,
        double beta);
{
    return mkldnn_lrn_backward_desc_init(
        lrn_desc, alg_kind, diff_data_desc, data_desc, local_size, alpha, beta);
}
...
{
    return mkldnn_batch_normalization_forward_desc_init(
...
mkldnn_status_t mkldnn_batch_normalization_backward_desc_init(
        ...
        double epsilon, unsigned flags);
{
    return mkldnn_batch_normalization_backward_desc_init(
 ...
 *     of @p format_kind. */
mkldnn_status_t
inner_product_forward_desc_init(
...
{
    return mkldnn_inner_product_forward_desc_init(
 ...
 *     of @p format_kind. */
mkldnn_status_t
inner_product_backward_data_desc_init(
        mkldnn_inner_product_desc_t     *ip_desc,
        const mkldnn_memory_desc_t      *diff_src_desc,
        const mkldnn_memory_desc_t      *weights_desc,
        const mkldnn_memory_desc_t      *diff_dst_desc)
{
    return mkldnn_inner_product_backward_data_desc_init(
 ...
 *     of @p format_kind. */
mkldnn_status_t
inner_product_backward_weights_desc_init(
        mkldnn_inner_product_desc_t     *ip_desc,
        const mkldnn_memory_desc_t      *src_desc,
        const mkldnn_memory_desc_t      *diff_weights_desc,
        const mkldnn_memory_desc_t      *diff_bias_desc,
        const mkldnn_memory_desc_t      *diff_dst_desc)
{
    return mkldnn_inner_product_backward_weights_desc_init(
...
mkldnn_status_t
convolution_relu_desc_init(
        mkldnn_convolution_relu_desc_t      *conv_relu_desc,
        const mkldnn_convolution_desc_t     *conv_desc,
        double                              negative_slope)
{
    return mkldnn_convolution_relu_desc_init(
            conv_relu_desc, conv_desc, negative_slope);
}
...
{
    return mkldnn_engine_get_count(kind);
}
...
engine_create(
        ...
        size_t                  index)
{
    return mkldnn_engine_create(engine, kind, index);
}
...
engine_get_kind(
        ...
        mkldnn_engine_kind_t    *kind)
{
    return mkldnn_engine_get_kind(engine, kind);
}
...
engine_destroy(
        mkldnn_engine_t     engine)
{
    return mkldnn_engine_destroy(engine);
}
...
{
    return mkldnn_stream_create(stream, stream_kind);
}
...
{
    return mkldnn_stream_submit(stream, n, primitives, error_primitive);
}
...
stream_wait(
        ...
        mkldnn_primitive_t  *error_primitive)
{
    return mkldnn_stream_wait(stream, block, error_primitive);
}
...
stream_rerun(
        ...
        mkldnn_primitive_t  *error_primitive)
{
    return mkldnn_stream_rerun(stream, error_primitive);
}
...
stream_destroy(
        mkldnn_stream_t     stream)
{
    return mkldnn_stream_destroy(stream);
}
