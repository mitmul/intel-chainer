...
# 
#     Returns:
#         mkldpy.ndarray: A new array with elements not initialized.
# 
#     .. seealso:: :func:`numpy.empty`
# 
#     """
#     return mkldpy.ndarray(shape, dtype=dtype, order=order)
...
# 
#     Args:
#         a (mkldpy.ndarray): Base array.
#         dtype: Data type specifier. The data type of ``a`` is used by default.
# 
#     Returns:
#         mkldpy.ndarray: A new array with same shape and dtype of ``a`` with
...
# 
#     Returns:
#         mkldpy.ndarray: A 2-D array with given diagonals filled with ones and
#         zeros elsewhere.
# 
...
# 
#     Returns:
#         mkldpy.ndarray: A 2-D identity array.
# 
...
# 
#     Returns:
#         mkldpy.ndarray: An array filled with ones.
# 
...
def zeros(shape, dtype=float, order='C'):
    ...
    """
    a = mkldpy.ndarray(shape, dtype, order=order)
    a.fill(0)
    return a
...
# 
#     Returns:
#         mkldpy.ndarray: An array filled with ``fill_value``.
# 
